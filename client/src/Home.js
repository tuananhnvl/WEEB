  ...
  return (
    ...
    <div className="WORKWITHUS MARGINSECTION">
      <div className="Container" style={{ padding: "0 1rem" }}>
        <div className="g3tr" onMouseOut={(e) => handleMouseEnter(e)} onMouseLeave={(e) => handleMouseLeave(e)}  /*  className="kuh4" */>
    ...
    <div className="SERVICES MARGINSECTION">
      ...
      <div className="Container" style={{ padding: "0 1rem" }}>
        ...
        <div className="BtnContactOnMobie">
